...
var joinUsForm = function () {
        ...
        $('#JoinUsForm').on('submit', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'php/join-us-form.php',
                data: $(this).serialize(),
                success: function (response) {
                    // Assuming the PHP script returns a success message
                    $('#form-message-success').show().html('Form Submitted Successfully! We will get back to you soon.');
                    $('#form-message-warning').hide();
                },
                error: function () {
                    $('#form-message-warning').show().html('There was an error submitting the form. Please try again.');
                    $('#form-message-success').hide();
                }
            });
        });
